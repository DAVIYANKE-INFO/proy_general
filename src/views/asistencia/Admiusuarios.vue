  ...
  methods: {
    open (event) {
     ...
     consulta12321()
                {
                    let varia = this;
                    console.log("carnet verifica: ",varia.usuarios);
                   
                            CARNET_= varia.usuarios;
    ...
    created:function() 
        {
                   ...
                   var usuar_tec_rrhh=JSON.parse(localStorage.getItem('directores')).tec_rrhh_login;
                    ...
                    {                        
                        console.log("pasantes: ", response.data)
                ...
                axios.post(varia.store+'/consultausuarios',{
                }).then(function (response) 
                {
                    console.log("RESPUESTA USUARIO SERVIDOR: ",response); 
                    varia.usuario_material=response.data;
